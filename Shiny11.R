...
#DATASETS
data1<-read.csv("C:\\Users\\lenovo IP330s\\Desktop\\Bhogle project\\FINAL_DATA_2016\\CRIME AGAINST CHILDREN.csv")
data2<-read.csv("C:\\Users\\lenovo IP330s\\Desktop\\Bhogle project\\FINAL_DATA_2016\\CRIME AGAINST WOMEN.csv")
data3<-read.csv("C:\\Users\\lenovo IP330s\\Desktop\\Bhogle project\\FINAL_DATA_2016\\CRIME AGAINST SC.csv")
data4<-read.csv("C:\\Users\\lenovo IP330s\\Desktop\\Bhogle project\\FINAL_DATA_2016\\CRIME AGAINST SENIOR CITIZENS.csv")
smartcities <- read.csv("C:\\Users\\lenovo IP330s\\Desktop\\Bhogle project\\smart1.csv")
